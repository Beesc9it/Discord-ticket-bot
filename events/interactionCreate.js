...
module.exports = async (client, int) => {
    ...
    switch (req) {
            ...
            selectMenu.addOptions([
              {
                emoji: '💬',
                label: 'Суд',
                description: 'Позвать судью',
                value: 'newTicket_Суд',
              },
              {
                emoji: '💂',
                label: 'Гвардия',
                description: 'Позвать гвардию',
              ...
              },
              {
                emoji: '💰',
                label: 'Банк',
                description: 'Позвать банкира',
                value: 'newTicket_Банк',
                },
            ]);
        ...
        case 'newTicket': {
          const roleMappings = {
            'newTicket_Суд': '924624970028548096',
            'newTicket_Гвардия': '1091083013946867787',
            'newTicket_Помощь': '996736764561604658',
            'newTicket_Банк': '1081290577066340484',
          };
        ...
        case 'closeTicket': {
          ...
          await channel.edit({
            permissionOverwrites: [
              ...
              {
                id: '924624970028548096', //суд
                deny: ['VIEW_CHANNEL', 'SEND_MESSAGES'],
              },
              {
                id: '996736764561604658', //помощь
                deny: ['VIEW_CHANNEL', 'SEND_MESSAGES'],
              },
              {
                id: '1081290577066340484', //банк
                deny: ['VIEW_CHANNEL', 'SEND_MESSAGES'],
              },
              {
                id: '1091083013946867787', //гвардия
                deny: ['VIEW_CHANNEL', 'SEND_MESSAGES'],
              },
              {
                id: '996736764561604658', //модер
                deny: ['VIEW_CHANNEL', 'SEND_MESSAGES'],
              },
              {
                id: '924747471643639878', //админ
                deny: ['VIEW_CHANNEL', 'SEND_MESSAGES'],
              },
            ],
          });
